...
class TestController(unittest.TestCase):
    def testDefault(self):
        ...
        with self.assertRaises(MooseException) as ex:
            runner = moosetest.base.Controller()
        self.assertIn("The parameter 'name' is marked as required", str(ex.exception))

        runner = moosetest.base.Controller(name='name')
    ...
    def testControllers(self):
        ...
        runner = moosetest.base.Controller(None, [ProxyController(),], name='name', test_platform='TempleOS')
