...
class TestHarnessTester(TestHarnessTestCase):
    def testWorkingDirectoryGood(self):
        ...
        output = self.runTests('--no-color', '-i', 'working_directory', '--re',
    ...
    def testAbsolutePath(self):
        ...
        self.assertRegex(e.output.decode('utf-8'),
                         r'tests/test_harness.absolute_path.*? FAILED \(ABSOLUTE PATH DETECTED\)')
    ...
    def testDirectoryNotFound(self):
        ...
        self.assertRegex(
            ...
            r'tests/test_harness.non_existent.*? FAILED \(WORKING DIRECTORY NOT FOUND\)')
    ...
    def testExodiff(self):
        ...
        e = cm.exception
        self.assertRegex(e.output.decode('utf-8'),
                         r'tests/test_harness.exodiff.*? FAILED \(EXODIFF\)')
    ...
    def testRunException(self):
        ...
        e = cm.exception
        self.assertRegex(e.output.decode('utf-8'),
                         r'tests/test_harness.runexception.*? FAILED \(EXPECTED ERROR MISSING\)')
